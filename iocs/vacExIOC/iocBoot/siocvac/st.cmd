...
dbLoadDatabase("dbd/vacExApp.dbd", 0, 0)
...
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP1,PORT=IP1_4,ADDR=5,DEV=QPC,STN=1")
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP2,PORT=IP1_4,ADDR=5,DEV=QPC,STN=2")
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP3,PORT=IP1_4,ADDR=5,DEV=QPC,STN=3")
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP4,PORT=IP1_4,ADDR=5,DEV=QPC,STN=4")

dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP5,PORT=IP5_8,ADDR=5,DEV=QPC,STN=1")
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP6,PORT=IP5_8,ADDR=5,DEV=QPC,STN=2")
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP7,PORT=IP5_8,ADDR=5,DEV=QPC,STN=3")
dbLoadRecords("$(VAC)/db/digitelPump.db", "P=FE:28:ID:,PUMP=IP8,PORT=IP5_8,ADDR=5,DEV=QPC,STN=4")
...
#!dbLoadRecords("$(VAC)/db/vs.db","P=FE:28:ID:,GAUGE=VS1,PORT=TV1,ADDR=0,DEV=MM200,STN=5")
#!dbLoadRecords("$(VAC)/db/vs.db","P=FE:28:ID:,GAUGE=VS2,PORT=TV1,ADDR=0,DEV=MM200,STN=6")

#!dbLoadRecords("$(VAC)/db/vs.db", "P=TV:,GAUGE=VS1,PORT=Televac1,ADDR=0,DEV=MX200,STN=3 1 0 1")
#!dbLoadRecords("$(VAC)/db/vs.db", "P=TV:,GAUGE=VS2,PORT=Televac1,ADDR=0,DEV=MX200,STN=4 0 2 2")
